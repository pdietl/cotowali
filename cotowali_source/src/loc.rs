...
use crate::Source;
use cotowali_utils::{clone_option_rc, define_with_params_and_init};
...
mod tests {
    ...
    fn test_eq() {
        ...
        assert_eq!(loc! {s1 => 0,1; 1,1}, loc! {0,1; 1,1});
        assert_eq!(loc! {0,1; 1,1}, loc! {s1 => 0,1; 1,1});
        assert_eq!(loc! {0,1; 1,1}, loc! {0,1; 1,1});
